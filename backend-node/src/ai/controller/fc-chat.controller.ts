...
function buildFcSystemPrompt(): string {
  return [
    ...
    '常用组件 type：input（多行文本用 props.type="textarea"）、inputNumber、select、radio、checkbox、',
    'datePicker（区间/日期时间用 props.type="daterange"/"datetime"）、timePicker、switch、rate、slider。',
    '字段对象形如：',
